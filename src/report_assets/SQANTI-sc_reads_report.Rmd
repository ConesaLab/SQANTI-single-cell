...
render_ggplotly(gg_JCs_in_cell, target_width = 400, target_height = 600) %>% layout(margin = list(t = 140))
```
...
if (exists("gg_annotation_of_genes_in_cell")) {
  render_ggplotly(gg_annotation_of_genes_in_cell, target_width = 1000)
}
```
...
if (exists("gg_annotation_of_genes_percent_in_cell")) {
  render_ggplotly(gg_annotation_of_genes_percent_in_cell, target_width = 1000)
}
```
...
if (exists("gg_annotation_of_reads_in_cell")) {
  render_ggplotly(gg_annotation_of_reads_in_cell, target_width = 1000)
}
```
...
if (exists("gg_read_bins_all")) {
  render_ggplotly(gg_read_bins_all, target_width = 1000)
}
```
...
if (exists("gg_read_bins")) {
  render_ggplotly(gg_read_bins, target_width = 1000)
}
```
...
```{r iso-per-gene-plot, fig.height=6, fig.width=12}
if (mode == "isoforms" && exists("gg_isoform_bins")) {
  render_ggplotly(gg_isoform_bins, target_width = 1000)
}
```
...
if (exists("gg_ujc_bins_all")) {
  render_ggplotly(gg_ujc_bins_all, target_width = 1000)
}
 ```
...
if (exists("gg_ujc_bins")) {
  render_ggplotly(gg_ujc_bins, target_width = 1000)
}
 ```
...
if (exists("gg_bulk_all_reads")) {
  render_ggplotly(gg_bulk_all_reads, target_width = 1000)
}
```
...
if (exists("gg_bulk_length_by_category")) {
  render_ggplotly(gg_bulk_length_by_category, target_width = 1000)
}
```
...
if (exists("gg_bulk_length_by_exon_type")) {
  render_ggplotly(gg_bulk_length_by_exon_type, target_width = 1000)
}
```
...
if (exists("gg_read_distr")) {
  render_ggplotly(gg_read_distr, target_width = 1000)
}
```
...
if (exists("gg_FSM_read_distr")) {
  render_ggplotly(gg_FSM_read_distr, target_width = 1000)
}
```
...
if (exists("gg_ISM_read_distr")) {
  render_ggplotly(gg_ISM_read_distr, target_width = 1000)
}
```
...
if (exists("gg_NIC_read_distr")) {
  render_ggplotly(gg_NIC_read_distr, target_width = 1000)
}
```
...
if (exists("gg_NNC_read_distr")) {
  render_ggplotly(gg_NNC_read_distr, target_width = 1000)
}
```
...
if (exists("gg_genic_read_distr")) {
  render_ggplotly(gg_genic_read_distr, target_width = 1000)
}
```
...
if (exists("gg_antisense_read_distr")) {
  render_ggplotly(gg_antisense_read_distr, target_width = 1000)
}
```
...
if (exists("gg_fusion_read_distr")) {
  render_ggplotly(gg_fusion_read_distr, target_width = 1000)
}
```
...
if (exists("gg_intergenic_read_distr")) {
  render_ggplotly(gg_intergenic_read_distr, target_width = 1000)
}
```
...
if (exists("gg_genic_intron_read_distr")) {
  render_ggplotly(gg_genic_intron_read_distr, target_width = 1000)
}
```
...
if (exists("gg_read_distr_mono")) {
  render_ggplotly(gg_read_distr_mono, target_width = 1000)
}
```
...
if (exists("gg_FSM_mono_read_distr")) {
  render_ggplotly(gg_FSM_mono_read_distr, target_width = 1000)
}
```
...
if (exists("gg_ISM_mono_read_distr")) {
  render_ggplotly(gg_ISM_mono_read_distr, target_width = 1000)
}
```
...
if (exists("gg_NIC_mono_read_distr")) {
  render_ggplotly(gg_NIC_mono_read_distr, target_width = 1000)
}
```
...
if (exists("gg_genic_mono_read_distr")) {
  render_ggplotly(gg_genic_mono_read_distr, target_width = 1000)
}
```
...
if (exists("gg_antisense_mono_read_distr")) {
  render_ggplotly(gg_antisense_mono_read_distr, target_width = 1000)
}
```
...
if (exists("gg_intergenic_mono_read_distr")) {
  render_ggplotly(gg_intergenic_mono_read_distr, target_width = 1000)
}
```
...
if (exists("gg_genic_intron_mono_read_distr")) {
  render_ggplotly(gg_genic_intron_mono_read_distr, target_width = 1000)
}
```
...
if (exists("gg_ref_coverage_across_category")) {
  render_ggplotly(gg_ref_coverage_across_category, target_width = 1000)
}
```
...
if (exists("gg_SQANTI_across_category")) {
  render_ggplotly(gg_SQANTI_across_category, target_width = 1000)
}
```
...
if (exists("gg_exon_mono_by_category")) {
  render_ggplotly(gg_exon_mono_by_category, target_width = 1000)
}
```
...
if (exists("gg_SQANTI_across_FSM")) {
  render_ggplotly(gg_SQANTI_across_FSM, target_width = 1000)
}
```
...
if (exists("gg_SQANTI_across_ISM")) {
  render_ggplotly(gg_SQANTI_across_ISM, target_width = 1000)
}
```
...
if (exists("gg_SQANTI_across_NIC")) {
  render_ggplotly(gg_SQANTI_across_NIC, target_width = 1000)
}
```
...
if (exists("gg_SQANTI_across_NNC")) {
  render_ggplotly(gg_SQANTI_across_NNC, target_width = 1000)
}
```
...
if (exists("gg_SQANTI_across_Genic")) {
  render_ggplotly(gg_SQANTI_across_Genic, target_width = 1000)
}
```
...
if (exists("gg_SQANTI_across_Antisense")) {
  render_ggplotly(gg_SQANTI_across_Antisense, target_width = 1000)
}
```
...
if (exists("gg_SQANTI_across_Fusion")) {
  render_ggplotly(gg_SQANTI_across_Fusion, target_width = 1000)
}
```
...
if (exists("gg_SQANTI_across_Intergenic")) {
  render_ggplotly(gg_SQANTI_across_Intergenic, target_width = 1000)
}
```
...
if (exists("gg_SQANTI_across_Genic_Intron")) {
  render_ggplotly(gg_SQANTI_across_Genic_Intron, target_width = 1000)
}
```
...
if (exists("gg_exon_mean_by_category")) {
  render_ggplotly(gg_exon_mean_by_category, target_width = 1000)
}
```
...
if (exists("gg_exon_profile_by_category") && !is.null(gg_exon_profile_by_category[["FSM"]])) {
  render_ggplotly(gg_exon_profile_by_category[["FSM"]], target_width = 1000)
}
```
...
if (exists("gg_exon_profile_by_category") && !is.null(gg_exon_profile_by_category[["ISM"]])) {
  render_ggplotly(gg_exon_profile_by_category[["ISM"]], target_width = 1000)
}
```
...
if (exists("gg_exon_profile_by_category") && !is.null(gg_exon_profile_by_category[["NIC"]])) {
  render_ggplotly(gg_exon_profile_by_category[["NIC"]], target_width = 1000)
}
```
...
if (exists("gg_exon_profile_by_category") && !is.null(gg_exon_profile_by_category[["NNC"]])) {
  render_ggplotly(gg_exon_profile_by_category[["NNC"]], target_width = 1000)
}
```
...
if (exists("gg_exon_profile_by_category") && !is.null(gg_exon_profile_by_category[["Genic Genomic"]])) {
  render_ggplotly(gg_exon_profile_by_category[["Genic Genomic"]], target_width = 1000)
}
```
...
if (exists("gg_exon_profile_by_category") && !is.null(gg_exon_profile_by_category[["Antisense"]])) {
  render_ggplotly(gg_exon_profile_by_category[["Antisense"]], target_width = 1000)
}
```
...
if (exists("gg_exon_profile_by_category") && !is.null(gg_exon_profile_by_category[["Fusion"]])) {
  render_ggplotly(gg_exon_profile_by_category[["Fusion"]], target_width = 1000)
}
```
...
if (exists("gg_exon_profile_by_category") && !is.null(gg_exon_profile_by_category[["Intergenic"]])) {
  render_ggplotly(gg_exon_profile_by_category[["Intergenic"]], target_width = 1000)
}
```
...
if (exists("gg_exon_profile_by_category") && !is.null(gg_exon_profile_by_category[["Genic Intron"]])) {
  render_ggplotly(gg_exon_profile_by_category[["Genic Intron"]], target_width = 1000)
}
```
...
if (exists("gg_coding_across_category")) {
  render_ggplotly(gg_coding_across_category, target_width = 1000)
}
```
...
if (exists("gg_non_coding_across_category")) {
  render_ggplotly(gg_non_coding_across_category, target_width = 1000)
}
```
...
if (exists("gg_known_novel_canon")) {
  render_ggplotly(gg_known_novel_canon, target_width = 1000)
}
```
...
if (exists("gg_sj_type_by_category_stack")) {
  ...
  render_ggplotly(gg_sj_type_by_category_stack, target_width = 1000)
}
```
...
if (exists("gg_allcanon_by_category")) {
  render_ggplotly(gg_allcanon_by_category, target_width = 1000)
}
```
...
if (exists("gg_rts_all_by_sjtype")) {
  render_ggplotly(gg_rts_all_by_sjtype, target_width = 1000)
}
```
...
if (exists("gg_rts_unique_by_sjtype")) {
  render_ggplotly(gg_rts_unique_by_sjtype, target_width = 1000)
}
```
...
if (exists("gg_bad_feature")) {
  render_ggplotly(gg_bad_feature, target_width = 1000)
}
```
...
if (exists("gg_intrapriming_by_category")) {
  render_ggplotly(gg_intrapriming_by_category, target_width = 1000)
}
```
...
if (exists("gg_RTS_by_category")) {
  render_ggplotly(gg_RTS_by_category, target_width = 1000)
}
```
...
if (exists("gg_noncanon_by_category")) {
  render_ggplotly(gg_noncanon_by_category, target_width = 1000)
}
```
...
if (exists("gg_nmd_by_category")) {
  render_ggplotly(gg_nmd_by_category, target_width = 1000)
}
```
...
if (exists("gg_good_feature")) {
  render_ggplotly(gg_good_feature, target_width = 1000)
}
```
...
<div id="goodq-across-dropdown" class="dropdown-toolbar">
  <div class="btn-group">
    ...
    <ul class="dropdown-menu dropdown-menu-right" role="menu">
      ...
      <li><a href="#" data-target="#goodq-sr-validation">SJs Validated by Short Reads</a></li>
      <li><a href="#" data-target="#goodq-tss-validation">TSS Validated by Short Reads</a></li>
    </ul>
  </div>
</div>
```
...
if (exists("gg_tss_annotation_support")) {
  render_ggplotly(gg_tss_annotation_support, target_width = 1000)
}
```
...
if (exists("CAGE_peak") && CAGE_peak && exists("gg_cage_peak_support")) {
  render_ggplotly(gg_cage_peak_support, target_width = 1000)
}
```
...
if (exists("polyA_motif_list") && polyA_motif_list && exists("gg_polyA_motif_support")) {
  render_ggplotly(gg_polyA_motif_support, target_width = 1000)
}
```
...
```{r goodq-sr-validation, fig.height=6, fig.width=12}
if (exists("gg_sr_support_by_category")) {
  render_ggplotly(gg_sr_support_by_category, target_width = 1000)
}
```
...
```{r goodq-tss-validation, fig.height=6, fig.width=12}
if (exists("gg_tss_validation_by_category")) {
  render_ggplotly(gg_tss_validation_by_category, target_width = 1000)
}
```
...
if (mode != "reads") {
  style_str <- if (!exists("gg_sr_cluster_plots") || length(gg_sr_cluster_plots) == 0) "style='display:none;'" else ""
  cat(paste0("## Junctions Coverage by Short Reads {", style_str, "}\n"))
}
```
...
```{r sr-cluster-missing, results='asis'}
if (mode == "isoforms" && !show_sr_cluster) {
  cat("Short Read Validation data (coverage) not available or Clustering was not run.\n")
}
```
...
if (show_sr_cluster && !is.null(gg_sr_cluster_plots[["All Transcripts"]])) {
  render_ggplotly(gg_sr_cluster_plots[["All Transcripts"]], target_width = 1000)
}
```
</div>
...
if (show_sr_cluster && !is.null(gg_sr_cluster_plots[["FSM"]])) {
  render_ggplotly(gg_sr_cluster_plots[["FSM"]], target_width = 1000)
}
```
</div>
...
if (show_sr_cluster && !is.null(gg_sr_cluster_plots[["ISM"]])) {
  render_ggplotly(gg_sr_cluster_plots[["ISM"]], target_width = 1000)
}
```
</div>
...
if (show_sr_cluster && !is.null(gg_sr_cluster_plots[["NIC"]])) {
  render_ggplotly(gg_sr_cluster_plots[["NIC"]], target_width = 1000)
}
```
</div>
...
if (show_sr_cluster && !is.null(gg_sr_cluster_plots[["NNC"]])) {
  render_ggplotly(gg_sr_cluster_plots[["NNC"]], target_width = 1000)
}
```
</div>
...
if (show_sr_cluster && !is.null(gg_sr_cluster_plots[["Genic_Genomic"]])) {
  render_ggplotly(gg_sr_cluster_plots[["Genic_Genomic"]], target_width = 1000)
}
```
</div>
...
if (show_sr_cluster && !is.null(gg_sr_cluster_plots[["Antisense"]])) {
  render_ggplotly(gg_sr_cluster_plots[["Antisense"]], target_width = 1000)
}
```
</div>
...
if (show_sr_cluster && !is.null(gg_sr_cluster_plots[["Fusion"]])) {
  render_ggplotly(gg_sr_cluster_plots[["Fusion"]], target_width = 1000)
}
```
</div>
...
if (show_sr_cluster && !is.null(gg_sr_cluster_plots[["Intergenic"]])) {
  render_ggplotly(gg_sr_cluster_plots[["Intergenic"]], target_width = 1000)
}
```
</div>
...
if (show_sr_cluster && !is.null(gg_sr_cluster_plots[["Genic Intron"]])) {
  render_ggplotly(gg_sr_cluster_plots[["Genic Intron"]], target_width = 1000)
}
```
</div>
...
if (mode != "reads") {
  style_str <- if (!exists("gg_tss_cluster_plots") || length(gg_tss_cluster_plots) == 0) "style='display:none;'" else ""
  cat(paste0("## TSS Coverage by Short Reads {", style_str, "}\n"))
}
```
...
if (show_tss_cluster && !is.null(gg_tss_cluster_plots[["All Transcripts"]])) {
  render_ggplotly(gg_tss_cluster_plots[["All Transcripts"]], target_width = 1000)
}
```
</div>
...
if (show_tss_cluster && !is.null(gg_tss_cluster_plots[["FSM"]])) {
  render_ggplotly(gg_tss_cluster_plots[["FSM"]], target_width = 1000)
}
```
</div>
...
if (show_tss_cluster && !is.null(gg_tss_cluster_plots[["ISM"]])) {
  render_ggplotly(gg_tss_cluster_plots[["ISM"]], target_width = 1000)
}
```
</div>
...
if (show_tss_cluster && !is.null(gg_tss_cluster_plots[["NIC"]])) {
  render_ggplotly(gg_tss_cluster_plots[["NIC"]], target_width = 1000)
}
```
</div>
...
if (show_tss_cluster && !is.null(gg_tss_cluster_plots[["NNC"]])) {
  render_ggplotly(gg_tss_cluster_plots[["NNC"]], target_width = 1000)
}
```
</div>
...
if (show_tss_cluster && !is.null(gg_tss_cluster_plots[["Genic Genomic"]])) {
  render_ggplotly(gg_tss_cluster_plots[["Genic Genomic"]], target_width = 1000)
}
```
</div>
...
if (show_tss_cluster && !is.null(gg_tss_cluster_plots[["Antisense"]])) {
  render_ggplotly(gg_tss_cluster_plots[["Antisense"]], target_width = 1000)
}
```
</div>
...
if (show_tss_cluster && !is.null(gg_tss_cluster_plots[["Fusion"]])) {
  render_ggplotly(gg_tss_cluster_plots[["Fusion"]], target_width = 1000)
}
```
</div>
...
if (show_tss_cluster && !is.null(gg_tss_cluster_plots[["Intergenic"]])) {
  render_ggplotly(gg_tss_cluster_plots[["Intergenic"]], target_width = 1000)
}
```
</div>

<div id="tss-cluster-Genic_Intron" class="toggle-pane hidden-pane" style="display:block;">
```{r tss-cluster-Genic_Intron, fig.height=6, fig.width=10, eval=show_tss_cluster, out.width="100%"}
if (show_tss_cluster && !is.null(gg_tss_cluster_plots[["Genic Intron"]])) {
  render_ggplotly(gg_tss_cluster_plots[["Genic Intron"]], target_width = 1000)
}
```
</div>