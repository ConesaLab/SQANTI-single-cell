...
render_ggplotly <- function(p, target_width = NULL, target_height = NULL) {
  # If it's already a plotly object, apply layout sizing
  ...
  if (inherits(p, "gg") || inherits(p, "ggplot")) {
    gp <- plotly::ggplotly(p, width = target_width, height = target_height)
    return(gp)
  }
...
fix_umap_plotly <- function(p) {
  # Convert to WebGL for performance (Disabled to fix blank plots)
  # p <- plotly::toWebGL(p)
...
print(plotly_to_ggplot(gg_umis_in_cells))
```
...
print(plotly_to_ggplot(gg_JCs_in_cell))
```
...
if (exists("gg_annotation_of_genes_in_cell")) {
  print(plotly_to_ggplot(gg_annotation_of_genes_in_cell))
}
```
...
if (exists("gg_annotation_of_genes_percent_in_cell")) {
  print(plotly_to_ggplot(gg_annotation_of_genes_percent_in_cell))
}
```
...
if (exists("gg_annotation_of_reads_in_cell")) {
  print(plotly_to_ggplot(gg_annotation_of_reads_in_cell))
}
```
...
if (exists("gg_read_bins_all")) {
  print(plotly_to_ggplot(gg_read_bins_all))
}
```
...
if (exists("gg_read_bins")) {
  print(plotly_to_ggplot(gg_read_bins))
}
```
...
if (mode == "isoforms" && exists("gg_isoform_bins")) {
  print(plotly_to_ggplot(gg_isoform_bins))
}
```
...
if (exists("gg_ujc_bins_all")) {
  print(plotly_to_ggplot(gg_ujc_bins_all))
}
 ```
...
if (exists("gg_ujc_bins")) {
  print(plotly_to_ggplot(gg_ujc_bins))
}
 ```
...
if (exists("gg_MT_perc")) {
  print(plotly_to_ggplot(gg_MT_perc))
}
```
...
if (exists("gg_bulk_all_reads")) {
  print(plotly_to_ggplot(gg_bulk_all_reads))
}
```
...
if (exists("gg_bulk_length_by_category")) {
  print(plotly_to_ggplot(gg_bulk_length_by_category))
}
```
...
if (exists("gg_bulk_length_by_exon_type")) {
  print(plotly_to_ggplot(gg_bulk_length_by_exon_type))
}
```
...
if (exists("gg_read_distr")) {
  print(plotly_to_ggplot(gg_read_distr))
}
```
...
if (exists("gg_FSM_read_distr")) {
  print(plotly_to_ggplot(gg_FSM_read_distr))
}
```
...
if (exists("gg_ISM_read_distr")) {
  print(plotly_to_ggplot(gg_ISM_read_distr))
}
```
...
if (exists("gg_NIC_read_distr")) {
  print(plotly_to_ggplot(gg_NIC_read_distr))
}
```
...
if (exists("gg_NNC_read_distr")) {
  print(plotly_to_ggplot(gg_NNC_read_distr))
}
```
...
if (exists("gg_genic_read_distr")) {
  print(plotly_to_ggplot(gg_genic_read_distr))
}
```
...
if (exists("gg_antisense_read_distr")) {
  print(plotly_to_ggplot(gg_antisense_read_distr))
}
```
...
if (exists("gg_fusion_read_distr")) {
  print(plotly_to_ggplot(gg_fusion_read_distr))
}
```
...
if (exists("gg_intergenic_read_distr")) {
  print(plotly_to_ggplot(gg_intergenic_read_distr))
}
```
...
if (exists("gg_genic_intron_read_distr")) {
  print(plotly_to_ggplot(gg_genic_intron_read_distr))
}
```
...
if (exists("gg_FSM_mono_read_distr")) {
  print(plotly_to_ggplot(gg_FSM_mono_read_distr))
}
```
...
if (exists("gg_ISM_mono_read_distr")) {
  print(plotly_to_ggplot(gg_ISM_mono_read_distr))
}
```
...
if (exists("gg_NIC_mono_read_distr")) {
  print(plotly_to_ggplot(gg_NIC_mono_read_distr))
}
```
...
if (exists("gg_genic_mono_read_distr")) {
  print(plotly_to_ggplot(gg_genic_mono_read_distr))
}
```
...
if (exists("gg_antisense_mono_read_distr")) {
  print(plotly_to_ggplot(gg_antisense_mono_read_distr))
}
```
...
if (exists("gg_genic_intron_mono_read_distr")) {
  print(plotly_to_ggplot(gg_genic_intron_mono_read_distr))
}
```
...
if (exists("gg_ref_coverage_across_category")) {
  print(plotly_to_ggplot(gg_ref_coverage_across_category))
}
```
...
if (exists("gg_SQANTI_across_category")) {
  print(plotly_to_ggplot(gg_SQANTI_across_category))
}
```
...
if (exists("gg_exon_mono_by_category")) {
  print(plotly_to_ggplot(gg_exon_mono_by_category))
}
```
...
if (exists("gg_SQANTI_across_FSM")) {
  print(plotly_to_ggplot(gg_SQANTI_across_FSM))
}
```
...
if (exists("gg_SQANTI_across_ISM")) {
  print(plotly_to_ggplot(gg_SQANTI_across_ISM))
}
```
...
if (exists("gg_SQANTI_across_NIC")) {
  print(plotly_to_ggplot(gg_SQANTI_across_NIC))
}
```
...
if (exists("gg_SQANTI_across_NNC")) {
  print(plotly_to_ggplot(gg_SQANTI_across_NNC))
}
```
...
if (exists("gg_SQANTI_across_Genic")) {
  print(plotly_to_ggplot(gg_SQANTI_across_Genic))
}
```
...
if (exists("gg_SQANTI_across_Antisense")) {
  print(plotly_to_ggplot(gg_SQANTI_across_Antisense))
}
```
...
if (exists("gg_SQANTI_across_Fusion")) {
  print(plotly_to_ggplot(gg_SQANTI_across_Fusion))
}
```
...
if (exists("gg_SQANTI_across_Intergenic")) {
  print(plotly_to_ggplot(gg_SQANTI_across_Intergenic))
}
```
...
if (exists("gg_SQANTI_across_Genic_Intron")) {
  print(plotly_to_ggplot(gg_SQANTI_across_Genic_Intron))
}
```
...
if (exists("gg_exon_mean_by_category")) {
  print(plotly_to_ggplot(gg_exon_mean_by_category))
}
```
...
if (exists("gg_exon_profile_by_category") && !is.null(gg_exon_profile_by_category[["FSM"]])) {
  print(plotly_to_ggplot(gg_exon_profile_by_category[["FSM"]]))
}
```
...
if (exists("gg_exon_profile_by_category") && !is.null(gg_exon_profile_by_category[["ISM"]])) {
  print(plotly_to_ggplot(gg_exon_profile_by_category[["ISM"]]))
}
```
...
if (exists("gg_exon_profile_by_category") && !is.null(gg_exon_profile_by_category[["NIC"]])) {
  print(plotly_to_ggplot(gg_exon_profile_by_category[["NIC"]]))
}
```
...
if (exists("gg_exon_profile_by_category") && !is.null(gg_exon_profile_by_category[["NNC"]])) {
  print(plotly_to_ggplot(gg_exon_profile_by_category[["NNC"]]))
}
```
...
if (exists("gg_exon_profile_by_category") && !is.null(gg_exon_profile_by_category[["Genic Genomic"]])) {
  print(plotly_to_ggplot(gg_exon_profile_by_category[["Genic Genomic"]]))
}
```
...
if (exists("gg_exon_profile_by_category") && !is.null(gg_exon_profile_by_category[["Antisense"]])) {
  print(plotly_to_ggplot(gg_exon_profile_by_category[["Antisense"]]))
}
```
...
if (exists("gg_exon_profile_by_category") && !is.null(gg_exon_profile_by_category[["Fusion"]])) {
  print(plotly_to_ggplot(gg_exon_profile_by_category[["Fusion"]]))
}
```
...
if (exists("gg_exon_profile_by_category") && !is.null(gg_exon_profile_by_category[["Intergenic"]])) {
  print(plotly_to_ggplot(gg_exon_profile_by_category[["Intergenic"]]))
}
```
...
if (exists("gg_exon_profile_by_category") && !is.null(gg_exon_profile_by_category[["Genic Intron"]])) {
  print(plotly_to_ggplot(gg_exon_profile_by_category[["Genic Intron"]]))
}
```
...
if (exists("gg_coding_across_category")) {
  print(plotly_to_ggplot(gg_coding_across_category))
}
```
...
if (exists("gg_non_coding_across_category")) {
  print(plotly_to_ggplot(gg_non_coding_across_category))
}
```
...
if (exists("gg_known_novel_canon")) {
  print(plotly_to_ggplot(gg_known_novel_canon))
}
```
...
if (exists("gg_allcanon_by_category")) {
  print(plotly_to_ggplot(gg_allcanon_by_category))
}
```
...
if (exists("gg_rts_all_by_sjtype")) {
  print(plotly_to_ggplot(gg_rts_all_by_sjtype))
}
```
...
if (exists("gg_rts_unique_by_sjtype")) {
  print(plotly_to_ggplot(gg_rts_unique_by_sjtype))
}
```
...
if (exists("gg_bad_feature")) {
  print(plotly_to_ggplot(gg_bad_feature))
}
```
...
if (exists("gg_intrapriming_by_category")) {
  print(plotly_to_ggplot(gg_intrapriming_by_category))
}
```
...
if (exists("gg_RTS_by_category")) {
  print(plotly_to_ggplot(gg_RTS_by_category))
}
```
...
if (exists("gg_noncanon_by_category")) {
  print(plotly_to_ggplot(gg_noncanon_by_category))
}
```
...
if (exists("gg_nmd_by_category")) {
  print(plotly_to_ggplot(gg_nmd_by_category))
}
```
...
if (exists("gg_good_feature")) {
  print(plotly_to_ggplot(gg_good_feature))
}
```
...
if (exists("gg_tss_annotation_support")) {
  print(plotly_to_ggplot(gg_tss_annotation_support))
}
```
...
if (exists("polyA_motif_list") && polyA_motif_list && exists("gg_polyA_motif_support")) {
  print(plotly_to_ggplot(gg_polyA_motif_support))
}
```
...
if (exists("gg_canon_by_category")) {
  print(plotly_to_ggplot(gg_canon_by_category))
}
```
...
if (exists("gg_sr_support_by_category")) {
  print(plotly_to_ggplot(gg_sr_support_by_category))
}
```
...
if (exists("gg_tss_validation_by_category")) {
  print(plotly_to_ggplot(gg_tss_validation_by_category))
}
```
...
if (mode != "reads" && exists("gg_umap") && !is.null(gg_umap)) {
...
if (knitr::is_html_output()) {
  ...
  render_ggplotly(gg_umap, target_width = 800, target_height = 700) %>%
    layout(margin = list(t = 100)) %>% plotly::toWebGL()
} else {
...
if (show_umap && exists("gg_umap_by_category")) {
...
<script>
$(document).ready(function() {
  // Helper to trigger Plotly resize on a specific container
  function resizePlot(container) {
    if (!container) return;
    // Small delay to ensure the pane is fully visible and layout is computed
    setTimeout(function() {
      var plotDiv = $(container).find('.plotly').get(0);
      if (plotDiv) {
        Plotly.Plots.resize(plotDiv);
      }
      // Always trigger window resize as a catch-all
      window.dispatchEvent(new Event('resize'));
    }, 50);
  }
  ...
  $('#umap-cat-dropdown .dropdown-menu a').click(function(e) {
    ...
    $targetPane.removeClass('hidden-pane').show();
    resizePlot($targetPane);
  });

  // Handler for sr-cluster-dropdown
  $('#sr-cluster-dropdown .dropdown-menu a').click(function(e) {
    e.preventDefault();
    var target = $(this).data('target');
    var label = $(this).text();
    $('#sr-cluster-dropdown button .label').text(label);
    
    $('[id^="sr-cluster-"]').not('#sr-cluster-dropdown').addClass('hidden-pane').hide();
    var $targetPane = $(target);
    $targetPane.removeClass('hidden-pane').show();
    resizePlot($targetPane);
  });

  // Handler for goodq-across-dropdown
  $('#goodq-across-dropdown .dropdown-menu a').click(function(e) {
    e.preventDefault();
    var target = $(this).data('target');
    var label = $(this).text();
    $('#goodq-across-dropdown button .label').text(label);
    
    $('[id^="goodq-"]').filter('.toggle-pane').addClass('hidden-pane').hide();
    var $targetPane = $(target);
    $targetPane.removeClass('hidden-pane').show();
    resizePlot($targetPane);
  });

  // Handler for sr-umap-dropdown
  $('#sr-umap-dropdown .dropdown-menu a').click(function(e) {
    e.preventDefault();
    var target = $(this).data('target');
    var label = $(this).text();
    $('#sr-umap-dropdown button .label').text(label);
    $('[id^="sr-umap-"]').not('#sr-umap-dropdown').addClass('hidden-pane').hide();
    var $targetPane = $(target);
    $targetPane.removeClass('hidden-pane').show();
    resizePlot($targetPane);
  });

  // Handler for tss-umap-dropdown
  $('#tss-umap-dropdown .dropdown-menu a').click(function(e) {
    e.preventDefault();
    var target = $(this).data('target');
    var label = $(this).text();
    $('#tss-umap-dropdown button .label').text(label);
    $('[id^="tss-umap-"]').not('#tss-umap-dropdown').addClass('hidden-pane').hide();
    var $targetPane = $(target);
    $targetPane.removeClass('hidden-pane').show();
    resizePlot($targetPane);
  });

  // Global handler for Bootstrap tab switches to resize plots in the new tab
...
if (show_sr_cluster && !is.null(gg_sr_cluster_plots[["All Transcripts"]])) {
  print(plotly_to_ggplot(gg_sr_cluster_plots[["All Transcripts"]]))
}
```
</div>
...
if (show_sr_cluster && !is.null(gg_sr_cluster_plots[["FSM"]])) {
  print(plotly_to_ggplot(gg_sr_cluster_plots[["FSM"]]))
}
```
</div>
...
if (show_sr_cluster && !is.null(gg_sr_cluster_plots[["ISM"]])) {
  print(plotly_to_ggplot(gg_sr_cluster_plots[["ISM"]]))
}
```
</div>
...
if (show_sr_cluster && !is.null(gg_sr_cluster_plots[["NIC"]])) {
  print(plotly_to_ggplot(gg_sr_cluster_plots[["NIC"]]))
}
```
</div>
...
if (show_sr_cluster && !is.null(gg_sr_cluster_plots[["NNC"]])) {
  print(plotly_to_ggplot(gg_sr_cluster_plots[["NNC"]]))
}
```
</div>
...
if (show_sr_cluster && !is.null(gg_sr_cluster_plots[["Genic Genomic"]])) {
  print(plotly_to_ggplot(gg_sr_cluster_plots[["Genic Genomic"]]))
}
```
</div>
...
if (show_sr_cluster && !is.null(gg_sr_cluster_plots[["Antisense"]])) {
  print(plotly_to_ggplot(gg_sr_cluster_plots[["Antisense"]]))
}
```
</div>
...
if (show_sr_cluster && !is.null(gg_sr_cluster_plots[["Fusion"]])) {
  print(plotly_to_ggplot(gg_sr_cluster_plots[["Fusion"]]))
}
```
</div>
...
if (show_sr_cluster && !is.null(gg_sr_cluster_plots[["Intergenic"]])) {
  print(plotly_to_ggplot(gg_sr_cluster_plots[["Intergenic"]]))
}
```
</div>
...
if (show_sr_cluster && !is.null(gg_sr_cluster_plots[["Genic Intron"]])) {
  print(plotly_to_ggplot(gg_sr_cluster_plots[["Genic Intron"]]))
}
```
</div>
...
if (show_sr_cluster && !is.null(gg_sr_umap_plots[["All Transcripts"]])) {
  render_ggplotly(gg_sr_umap_plots[["All Transcripts"]], target_width = 800, target_height = 700) %>% fix_umap_plotly()
} else {
  print(ggplot2::ggplot() + ggplot2::annotate("text", x=0.5, y=0.5, label="No data available") + ggplot2::theme_void())
}
```
</div>
...
if (show_sr_cluster && !is.null(gg_sr_umap_plots[["FSM"]])) {
  render_ggplotly(gg_sr_umap_plots[["FSM"]], target_width = 800, target_height = 700) %>% fix_umap_plotly()
} else {
  print(ggplot2::ggplot() + ggplot2::annotate("text", x=0.5, y=0.5, label="No data available") + ggplot2::theme_void())
}
```
...
if (show_sr_cluster && !is.null(gg_sr_umap_plots[["ISM"]])) {
  render_ggplotly(gg_sr_umap_plots[["ISM"]], target_width = 800, target_height = 700) %>% fix_umap_plotly()
} else {
  print(ggplot2::ggplot() + ggplot2::annotate("text", x=0.5, y=0.5, label="No data available") + ggplot2::theme_void())
}
```
...
if (show_sr_cluster && !is.null(gg_sr_umap_plots[["NIC"]])) {
  render_ggplotly(gg_sr_umap_plots[["NIC"]], target_width = 800, target_height = 700) %>% fix_umap_plotly()
} else {
  print(ggplot2::ggplot() + ggplot2::annotate("text", x=0.5, y=0.5, label="No data available") + ggplot2::theme_void())
}
```
...
if (show_sr_cluster && !is.null(gg_sr_umap_plots[["NNC"]])) {
  render_ggplotly(gg_sr_umap_plots[["NNC"]], target_width = 800, target_height = 700) %>% fix_umap_plotly()
} else {
  print(ggplot2::ggplot() + ggplot2::annotate("text", x=0.5, y=0.5, label="No data available") + ggplot2::theme_void())
}
```
...
if (show_sr_cluster && !is.null(gg_sr_umap_plots[["Genic Genomic"]])) {
  render_ggplotly(gg_sr_umap_plots[["Genic Genomic"]], target_width = 800, target_height = 700) %>% fix_umap_plotly()
} else {
  print(ggplot2::ggplot() + ggplot2::annotate("text", x=0.5, y=0.5, label="No data available") + ggplot2::theme_void())
}
```
...
if (show_sr_cluster && !is.null(gg_sr_umap_plots[["Antisense"]])) {
  render_ggplotly(gg_sr_umap_plots[["Antisense"]], target_width = 800, target_height = 700) %>% fix_umap_plotly()
} else {
  print(ggplot2::ggplot() + ggplot2::annotate("text", x=0.5, y=0.5, label="No data available") + ggplot2::theme_void())
}
```
...
if (show_sr_cluster && !is.null(gg_sr_umap_plots[["Fusion"]])) {
  render_ggplotly(gg_sr_umap_plots[["Fusion"]], target_width = 800, target_height = 700) %>% fix_umap_plotly()
} else {
  print(ggplot2::ggplot() + ggplot2::annotate("text", x=0.5, y=0.5, label="No data available") + ggplot2::theme_void())
}
```
...
if (show_sr_cluster && !is.null(gg_sr_umap_plots[["Intergenic"]])) {
  render_ggplotly(gg_sr_umap_plots[["Intergenic"]], target_width = 800, target_height = 700) %>% fix_umap_plotly()
} else {
  print(ggplot2::ggplot() + ggplot2::annotate("text", x=0.5, y=0.5, label="No data available") + ggplot2::theme_void())
}
```
...
if (show_sr_cluster && !is.null(gg_sr_umap_plots[["Genic Intron"]])) {
  render_ggplotly(gg_sr_umap_plots[["Genic Intron"]], target_width = 800, target_height = 700) %>% fix_umap_plotly()
} else {
  print(ggplot2::ggplot() + ggplot2::annotate("text", x=0.5, y=0.5, label="No data available") + ggplot2::theme_void())
}
```
...
if (show_tss_cluster && !is.null(gg_tss_cluster_plots[["All Transcripts"]])) {
  print(plotly_to_ggplot(gg_tss_cluster_plots[["All Transcripts"]]))
}
```
</div>
...
if (show_tss_cluster && !is.null(gg_tss_cluster_plots[["FSM"]])) {
  print(plotly_to_ggplot(gg_tss_cluster_plots[["FSM"]]))
}
```
</div>
...
if (show_tss_cluster && !is.null(gg_tss_cluster_plots[["ISM"]])) {
  print(plotly_to_ggplot(gg_tss_cluster_plots[["ISM"]]))
}
```
</div>
...
if (show_tss_cluster && !is.null(gg_tss_cluster_plots[["NIC"]])) {
  print(plotly_to_ggplot(gg_tss_cluster_plots[["NIC"]]))
}
```
</div>
...
if (show_tss_cluster && !is.null(gg_tss_cluster_plots[["NNC"]])) {
  print(plotly_to_ggplot(gg_tss_cluster_plots[["NNC"]]))
}
```
</div>
...
if (show_tss_cluster && !is.null(gg_tss_cluster_plots[["Genic Genomic"]])) {
  print(plotly_to_ggplot(gg_tss_cluster_plots[["Genic Genomic"]]))
}
```
</div>
...
if (show_tss_cluster && !is.null(gg_tss_cluster_plots[["Antisense"]])) {
  print(plotly_to_ggplot(gg_tss_cluster_plots[["Antisense"]]))
}
```
</div>
...
if (show_tss_cluster && !is.null(gg_tss_cluster_plots[["Fusion"]])) {
  print(plotly_to_ggplot(gg_tss_cluster_plots[["Fusion"]]))
}
```
</div>
...
if (show_tss_cluster && !is.null(gg_tss_cluster_plots[["Intergenic"]])) {
  print(plotly_to_ggplot(gg_tss_cluster_plots[["Intergenic"]]))
}
```
</div>
...
if (show_tss_cluster && !is.null(gg_tss_umap_plots[["All Transcripts"]])) {
  render_ggplotly(gg_tss_umap_plots[["All Transcripts"]], target_width = 800, target_height = 700) %>% fix_umap_plotly()
} else {
  print(ggplot2::ggplot() + ggplot2::annotate("text", x=0.5, y=0.5, label="No data available") + ggplot2::theme_void())
}
```
...
if (show_tss_cluster && !is.null(gg_tss_umap_plots[["FSM"]])) {
  render_ggplotly(gg_tss_umap_plots[["FSM"]], target_width = 800, target_height = 700) %>% fix_umap_plotly()
} else {
  print(ggplot2::ggplot() + ggplot2::annotate("text", x=0.5, y=0.5, label="No data available") + ggplot2::theme_void())
}
```
...
if (show_tss_cluster && !is.null(gg_tss_umap_plots[["ISM"]])) {
  render_ggplotly(gg_tss_umap_plots[["ISM"]], target_width = 800, target_height = 700) %>% fix_umap_plotly()
} else {
  print(ggplot2::ggplot() + ggplot2::annotate("text", x=0.5, y=0.5, label="No data available") + ggplot2::theme_void())
}
```
...
if (show_tss_cluster && !is.null(gg_tss_umap_plots[["NIC"]])) {
  render_ggplotly(gg_tss_umap_plots[["NIC"]], target_width = 800, target_height = 700) %>% fix_umap_plotly()
} else {
  print(ggplot2::ggplot() + ggplot2::annotate("text", x=0.5, y=0.5, label="No data available") + ggplot2::theme_void())
}
```
...
if (show_tss_cluster && !is.null(gg_tss_umap_plots[["NNC"]])) {
  render_ggplotly(gg_tss_umap_plots[["NNC"]], target_width = 800, target_height = 700) %>% fix_umap_plotly()
} else {
  print(ggplot2::ggplot() + ggplot2::annotate("text", x=0.5, y=0.5, label="No data available") + ggplot2::theme_void())
}
```
...
if (show_tss_cluster && !is.null(gg_tss_umap_plots[["Genic Genomic"]])) {
  render_ggplotly(gg_tss_umap_plots[["Genic Genomic"]], target_width = 800, target_height = 700) %>% fix_umap_plotly()
} else {
  print(ggplot2::ggplot() + ggplot2::annotate("text", x=0.5, y=0.5, label="No data available") + ggplot2::theme_void())
}
```
...
if (show_tss_cluster && !is.null(gg_tss_umap_plots[["Antisense"]])) {
  render_ggplotly(gg_tss_umap_plots[["Antisense"]], target_width = 800, target_height = 700) %>% fix_umap_plotly()
} else {
  print(ggplot2::ggplot() + ggplot2::annotate("text", x=0.5, y=0.5, label="No data available") + ggplot2::theme_void())
}
```
...
if (show_tss_cluster && !is.null(gg_tss_umap_plots[["Fusion"]])) {
  render_ggplotly(gg_tss_umap_plots[["Fusion"]], target_width = 800, target_height = 700) %>% fix_umap_plotly()
} else {
  print(ggplot2::ggplot() + ggplot2::annotate("text", x=0.5, y=0.5, label="No data available") + ggplot2::theme_void())
}
```
...
if (show_tss_cluster && !is.null(gg_tss_umap_plots[["Intergenic"]])) {
  render_ggplotly(gg_tss_umap_plots[["Intergenic"]], target_width = 800, target_height = 700) %>% fix_umap_plotly()
} else {
  print(ggplot2::ggplot() + ggplot2::annotate("text", x=0.5, y=0.5, label="No data available") + ggplot2::theme_void())
}
```
...
if (show_tss_cluster && !is.null(gg_tss_umap_plots[["Genic Intron"]])) {
  render_ggplotly(gg_tss_umap_plots[["Genic Intron"]], target_width = 800, target_height = 700) %>% fix_umap_plotly()
} else {
  print(ggplot2::ggplot() + ggplot2::annotate("text", x=0.5, y=0.5, label="No data available") + ggplot2::theme_void())
}
```
