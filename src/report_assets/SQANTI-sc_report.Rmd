...
```{r monoexon-length-all-plot, fig.height=8, fig.width=10}
...
```{r monoexon-length-fsm-plot, fig.height=8, fig.width=10}
...
```{r monoexon-length-ism-plot, fig.height=8, fig.width=10}
...
```{r monoexon-length-nic-plot, fig.height=8, fig.width=10}
...
```{r monoexon-length-genic-plot, fig.height=8, fig.width=10}
...
```{r monoexon-length-antisense-plot, fig.height=8, fig.width=10}
...
```{r monoexon-length-intergenic-plot, fig.height=8, fig.width=10}
...
```{r monoexon-length-genicintron-plot, fig.height=8, fig.width=10}
...
```{r isoforms-ref-lengths-plot, fig.height=8, fig.width=10}
...
```{r sjchar-rts-section, results='asis'}
if (exists("mode") && mode == "isoforms") {
  # Isoforms mode: only one figure, show directly without dropdown
  cat("\n")
} else {
  # Reads mode: show full two-option dropdown
...
```{r sj-rts-uniq, fig.height=8, fig.width=12, eval=(!exists('mode') || mode != 'isoforms')}
...
```{r badfeatures-intrapriming, fig.height=8, fig.width=12}
...
```{r badfeatures-rts, fig.height=8, fig.width=12}
...
```{r badfeatures-noncanon, fig.height=8, fig.width=12}
...
```{r badfeatures-nmd, fig.height=8, fig.width=12}
