...
```{r cells-reads-plot, fig.height=6, fig.width=4}
...
```{r depth-umis, fig.height=6, fig.width=4, eval=show_umis}
...
```{r depth-ujcs, fig.height=6, fig.width=4, eval=show_ujcs}
...
```{r cells-genes-plot, fig.height=6, fig.width=4}
...
```{r genechar-mt, fig.height=6, fig.width=4}
...
```{r render-badq-dropdown, echo=FALSE, results='asis'}
badq_features <- list(
...
if (length(badq_available) > 0) {
  ...
  dropdown_items <- paste0(
    '      <li><a href="#" data-target="#', sapply(badq_available, `[[`, "id"),
    '">', sapply(badq_available, `[[`, "label"), '</a></li>'
  )
  cat(paste0(
    '<div id="badq-across-dropdown" class="dropdown-toolbar">\n',
    '  <div class="btn-group">\n',
    '    <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">\n',
    '      <span class="label">', default_label, '</span> <span class="caret"></span>\n',
    '    </button>\n',
    '    <ul class="dropdown-menu dropdown-menu-right" role="menu">\n',
...
```{r badfeatures-intrapriming, fig.height=8, fig.width=12, results='asis'}
if (exists("gg_intrapriming_by_category")) {
  cat('<div id="badfeatures-intrapriming" class="toggle-pane" style="display:block;">\n')
  print(gg_intrapriming_by_category)
  cat('\n</div>\n')
}
```

```{r badfeatures-rts, fig.height=8, fig.width=12, results='asis'}
if (exists("gg_RTS_by_category")) {
  cat('<div id="badfeatures-rts" class="toggle-pane hidden-pane" style="display:block;">\n')
  print(gg_RTS_by_category)
  cat('\n</div>\n')
}
```

```{r badfeatures-noncanon, fig.height=8, fig.width=12, results='asis'}
if (exists("gg_noncanon_by_category")) {
  cat('<div id="badfeatures-noncanon" class="toggle-pane hidden-pane" style="display:block;">\n')
  print(gg_noncanon_by_category)
  cat('\n</div>\n')
}
```

```{r badfeatures-nmd, fig.height=8, fig.width=12, results='asis'}
if (exists("gg_nmd_by_category")) {
  cat('<div id="badfeatures-nmd" class="toggle-pane hidden-pane" style="display:block;">\n')
...
```{r cat-cluster-FSM, fig.height=6, fig.width=10, eval=show_cat_cluster, out.width="100%"}
...
```{r cat-cluster-ISM, fig.height=6, fig.width=10, eval=show_cat_cluster, out.width="100%"}
...
```{r cat-cluster-NIC, fig.height=6, fig.width=10, eval=show_cat_cluster, out.width="100%"}
...
```{r cat-cluster-NNC, fig.height=6, fig.width=10, eval=show_cat_cluster, out.width="100%"}
...
```{r cat-cluster-Genic_Genomic_cat, fig.height=6, fig.width=10, eval=show_cat_cluster, out.width="100%"}
...
```{r cat-cluster-Antisense, fig.height=6, fig.width=10, eval=show_cat_cluster, out.width="100%"}
...
```{r cat-cluster-Fusion, fig.height=6, fig.width=10, eval=show_cat_cluster, out.width="100%"}
...
```{r cat-cluster-Intergenic, fig.height=6, fig.width=10, eval=show_cat_cluster, out.width="100%"}
...
```{r cat-cluster-Genic_Intron_cat, fig.height=6, fig.width=10, eval=show_cat_cluster, out.width="100%"}
...
```{r len-cluster-All, fig.height=6, fig.width=10, eval=show_len_cluster, out.width="100%"}
...
```{r len-cluster-FSM, fig.height=6, fig.width=10, eval=show_len_cluster, out.width="100%"}
...
```{r len-cluster-ISM, fig.height=6, fig.width=10, eval=show_len_cluster, out.width="100%"}
...
```{r len-cluster-NIC, fig.height=6, fig.width=10, eval=show_len_cluster, out.width="100%"}
...
```{r len-cluster-NNC, fig.height=6, fig.width=10, eval=show_len_cluster, out.width="100%"}
...
```{r len-cluster-GenicGenomic, fig.height=6, fig.width=10, eval=show_len_cluster, out.width="100%"}
...
```{r len-cluster-Antisense, fig.height=6, fig.width=10, eval=show_len_cluster, out.width="100%"}
...
```{r len-cluster-Fusion, fig.height=6, fig.width=10, eval=show_len_cluster, out.width="100%"}
...
```{r len-cluster-Intergenic, fig.height=6, fig.width=10, eval=show_len_cluster, out.width="100%"}
...
```{r len-cluster-GenicIntron, fig.height=6, fig.width=10, eval=show_len_cluster, out.width="100%"}
...
```{r sr-cluster-Global, fig.height=6, fig.width=10, eval=show_sr_cluster, out.width="100%"}
...
```{r sr-cluster-FSM, fig.height=6, fig.width=10, eval=show_sr_cluster, out.width="100%"}
...
```{r sr-cluster-ISM, fig.height=6, fig.width=10, eval=show_sr_cluster, out.width="100%"}
...
```{r sr-cluster-NIC, fig.height=6, fig.width=10, eval=show_sr_cluster, out.width="100%"}
...
```{r sr-cluster-NNC, fig.height=6, fig.width=10, eval=show_sr_cluster, out.width="100%"}
...
```{r sr-cluster-Genic_Genomic, fig.height=6, fig.width=10, eval=show_sr_cluster, out.width="100%"}
...
```{r sr-cluster-Antisense, fig.height=6, fig.width=10, eval=show_sr_cluster, out.width="100%"}
...
```{r sr-cluster-Fusion, fig.height=6, fig.width=10, eval=show_sr_cluster, out.width="100%"}
...
```{r sr-cluster-Intergenic, fig.height=6, fig.width=10, eval=show_sr_cluster, out.width="100%"}
...
```{r sr-cluster-Genic_Intron, fig.height=6, fig.width=10, eval=show_sr_cluster, out.width="100%"}
...
```{r tss-cluster-Global, fig.height=6, fig.width=10, eval=show_tss_cluster, out.width="100%"}
...
```{r tss-cluster-FSM, fig.height=6, fig.width=10, eval=show_tss_cluster, out.width="100%"}
...
```{r tss-cluster-ISM, fig.height=6, fig.width=10, eval=show_tss_cluster, out.width="100%"}
...
```{r tss-cluster-NIC, fig.height=6, fig.width=10, eval=show_tss_cluster, out.width="100%"}
...
```{r tss-cluster-NNC, fig.height=6, fig.width=10, eval=show_tss_cluster, out.width="100%"}
...
```{r tss-cluster-Genic_Genomic, fig.height=6, fig.width=10, eval=show_tss_cluster, out.width="100%"}
...
```{r tss-cluster-Antisense, fig.height=6, fig.width=10, eval=show_tss_cluster, out.width="100%"}
...
```{r tss-cluster-Fusion, fig.height=6, fig.width=10, eval=show_tss_cluster, out.width="100%"}
...
```{r tss-cluster-Intergenic, fig.height=6, fig.width=10, eval=show_tss_cluster, out.width="100%"}
